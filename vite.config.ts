...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@invertase/react-native-apple-authentication': stub(
        'web/stubs/apple-auth.ts',
      ),
      '@react-native-google-signin/google-signin': stub(
        'web/stubs/google-signin.ts',
      ),
      'mixpanel-react-native': stub('web/stubs/mixpanel.ts'),
      'react-native-purchases': stub('web/stubs/purchases.ts'),
