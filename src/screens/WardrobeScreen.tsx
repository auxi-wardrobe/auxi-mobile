...
export const WardrobeScreen = () => {
  ...
  const handleConfirmChange = () => {
    ...
    track('wardrobe_change_item_confirmed', { item_id: selectedItemId });
    // Reuse the "Build around this" pin pipeline: popTo Home dismisses this
    // picker AND the ItemDetail modal beneath it, landing on Home with the
    // chosen item set as `pinFromDetail`.
    navigation.popTo('Home', { pinFromDetail: selectedItemId });
  };
