...
// NavigationContainer.
// The open menu spans 4/5 of the screen width (Figma); the remaining 1/5 (minus
// the 12px gap) is the peek of pushed app content. RootDrawer pushes the content
// by this width + 12 so the two layers never touch.
