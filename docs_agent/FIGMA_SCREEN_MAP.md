# Figma Screen Map (Locked)

Last updated: 2026-02-27
File key: `0nXXMAR4Arf1ZfjtQvtBh0`

This map locks one Figma node per in-scope route screen for implementation parity.

| Screen | Locked Node ID | Exact Node URL | Baseline Screenshot | Target File |
|---|---|---|---|---|
| Welcome | `392:1911` | https://www.figma.com/design/0nXXMAR4Arf1ZfjtQvtBh0/Auxi?node-id=392-1911 | Captured via Figma MCP screenshot | `src/screens/WelcomeScreen.tsx` |
...
1. Match by exact screen copy text first.
2. If duplicates exist, choose the node in the current MVP flow chain.
3. If still duplicated, pick the latest maintained section variant in file flow order.
4. If unresolved after two candidates, pause implementation and request exact node URL.
