...
- 👥 **Nhiều người làm cùng lúc thoải mái** — mỗi lần deploy là một branch riêng
  `web-preview/...`, không ai đụng ai.
...
>
> Bạn **không cần tự tạo branch** gì cả — mỗi lần "deploy đi", hệ thống tự sinh
> một branch riêng `web-preview/...` cho bản preview của bạn.
...
Preview chỉ là **bản nháp để xem**. Branch `web-preview/*` **không tự chui vào
